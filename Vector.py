...
class Vec2:
  ...
  Methods:
  -------
  __add__ -- Overloads '+' for two vectors
  __sub__ -- Overloads '-' for two vectors
  __str__ -- Overloads 'str' for a vector
...
class Vec3:
  ...
  def __init__(self, x, y, z):
    ...
    self.dir = (math.acos(x/math.sqrt(self.mag_Sq)),math.acos(y/math.sqrt(self.mag_Sq)),math.acos(z/math.sqrt(self.mag_Sq)))
